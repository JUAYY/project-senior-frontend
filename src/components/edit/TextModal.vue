<template>
  <q-card class="">
    <q-card-section class="row q-pb-none">
      <div class="w-[500px] justify-center items-center object-center py-3">
        <div class="flex">
          <div>
            <svg
          ...
          <div class="font-bold text-lg">Add your text</div>
        </div>
        <div class="my-1 w-[100%] justify-center items-center">
          <div
            class="q-pa-md justify-center items-center flex"
            style="max-width: 800px"
          >
            <q-form
              @submit="onSubmit"
              @reset="onReset"
              class="q-gutter-md w-[800px]"
            >
              <q-input
                filled
                v-model="name"
...
const onSubmit = () => {
  if (!txtConfig.value) return;
  txtConfig.value.config.text = name.value;
  emit("addNewMessage", txtConfig.value);
};
